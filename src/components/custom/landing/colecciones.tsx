...
const CollectionCard: React.FC<CollectionCardProps> = ({ imageSrc, title }) => (
  <div className="flex flex-col w-1/3 ">
    <div className="flex overflow-hidden relative flex-col grow justify-center p-2.5 text-xl text-white whitespace-nowrap rounded-2xl aspect-[0.81] max-md:mt-6">
      ...
      <div className="flex relative justify-between mt-80 p-3 rounded-2xl border-2 border-white border-solid bg-black bg-opacity-60 max-md:mt-10">
        <div>{title}</div>
        <ArrowUpRight />
      </div>
    </div>
    ...
    <section className="flex justify-center items-center mt-32 mx-52">
      <div className="flex flex-col justify-center mt-2.5 w-full">
        ...
        <div className="mt-10 max-md:max-w-full">
          <div className="flex items-end gap-8 max-md:flex-col max-md:gap-0">
